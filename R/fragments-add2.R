...
#' Adds MS2 Fragments
#'
#' @param x An instance of class `Spectra` of length 1, containing a spectra
#'  variable `"sequence"` with a `character(1)` representing a valid peptide sequence.
#'
...
#'
#' @return additional parameters (except verbose) passed to `calculateFragments2()`
#'  to calculate fragment m/z values to be added to the spectra in x.
#'
...
#' plotSpectra(sp, labels = addFragments2, labelPos = 3)
